...
const Banner: React.FC = () => {
  ...
  return (
    <div className={`auralis-banner shadow-lg ${isDark ? 'text-white' : 'text-dark'}`}>
      <Container className="py-5 d-flex flex-column align-items-center position-relative z-1">
        ...
        <p className={`fs-5 mb-4 opacity-75 text-center ${isDark ? 'text-light' : 'text-secondary'}`} style={{ maxWidth: '600px' }}>
